...
import '../contents/matrix/encrypt.js';
import '../contents/matrix/decrypt.js';
import '../contents/matrix/matrix.js';

class MatrixPage extends LitElement {
  static properties = {
...
customElements.define('matrix-page', MatrixPage);
